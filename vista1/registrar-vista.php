...
<div class="container-form">
        <div class="header">
            ...
            <div class="menu">
                <a href="../index.php"><li class="module-login">INICIAR SESION</li></a>
                <a href="./registrar-vista.php"><li class="module-register active">REGISTRAR</li></a>
            </div>
        </div>
        
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="form">
            <div class="welcome-form"><h2>VETERINARIA</h2></div>
